...
// Reorder TEACHERS_DATA based on user request:
// FRANCO(Leonardo?) GABRIEL(Terry) RENATO
// CARLOS DIEGO(Baglietto) EDUARDO
// GABRIEL(Cutti) MARCO(Emilio?) DIEGO(Meneses) JOSE(Vega)
